...
const consentCopy = {
  es: {
    eyebrow: "COOKIES · VOS DECIDÍS",
    title: "¿Me ayudás a no diseñar a ciegas?",
    text: "Si aceptás, Google Analytics me cuenta qué funciona y cómo rinde el sitio. Nunca ve nombres, emails, teléfonos ni mensajes.",
    accept: "Dale, podés medir",
    reject: "Prefiero que no",
    privacy: "Ver privacidad",
    preferences: "Preferencias de analítica",
  },
  en: {
    eyebrow: "COOKIES · YOUR CALL",
    title: "Can you help me design with less guesswork?",
    text: "If you’re okay with it, Google Analytics shows me what’s working and how the site performs. It never sees names, email addresses, phone numbers or messages.",
    accept: "Sure, measure away",
    reject: "No, thanks",
