...
| D-026 | 2026-08-09 | Usar temporalmente el subdominio público de Sites como dominio de producción del portfolio. | Vigente | Permite operar y validar la experiencia pública sin bloquear la publicación por una decisión de dominio propio que puede tomarse más adelante. |
...
| D-029 | 2026-08-09 | Incorporar analytics en una etapa posterior y no modificar Privacidad hasta definir proveedor, eventos, datos, retención y consentimiento. | Vigente | La política debe describir el flujo real y no una integración todavía indeterminada. |
...
| D-032 | 2026-08-10 | Usar Google Apps Script, una hoja privada de Google Sheets y Google Mail como pipeline de contacto. | Vigente, pendiente de autorización | Aprovecha recursos disponibles sin sumar un proveedor pago: conserva la consulta, notifica a `alegfink@gmail.com` y permite monitoreo manual. La app web no se activa hasta que Alejandro autorice personalmente sus permisos. |
