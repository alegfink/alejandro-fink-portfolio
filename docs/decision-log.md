...
| D-028 | 2026-08-09 | Mantener desactivado el envío dentro del sitio y mostrar el formulario propuesto sólo para revisión. | Vigente | La estructura puede evaluarse sin recopilar datos; proveedor, webhook, antispam, monitoreo y actualización de Privacidad siguen siendo requisitos para activarlo. |
