...
export const projects: Project[] = [
  {
    ...
    content: {
      es: {
        ...
        solution: "Definí la categoría, la marca y la oferta; construí un storefront headless organizado alrededor de necesidades como carga, limpieza, autonomía y orden; y conecté catálogo, carrito, checkout, contenido, campañas y una capa propia de medición.",
        role: "Fundé y opero Torvena de punta a punta. Dirigí estrategia, producto, UX y la implementación técnica asistida por IA, además de catálogo, precios, contenido, campañas, soporte, logística e iteración cotidiana.",
        decisions: [
          ...
          { title: "Evolucionar hacia un storefront headless", text: "Después de una primera etapa con Lovable, reestructuré la experiencia con Shopify Hydrogen para tener mayor control sobre contenido, recorrido y sistema visual." },
        ...
        limits: ["La tienda pública, el carrito y el checkout están operativos. Lo que todavía no está disponible es el acceso privado para que cada cliente inicie sesión y gestione su cuenta.", "El seguimiento first-party de pedidos pagados funciona en producción y forma parte de la operación habitual.", "El próximo paso es incorporar Google Analytics para consolidar tráfico, atribución y conversión, y documentar resultados sobre una fuente y un período consistentes."],
        outcomes: ["Negocio activo, con pedidos reales y campañas publicitarias en curso.", "Operación nacional que reúne venta, soporte, logística y aprendizaje continuo.", "Experiencia verificable en construcción y operación de un e-commerce propio."],
        seoTitle: "Torvena — Caso de e-commerce de Alejandro Fink",
        seoDescription: "Cómo Alejandro Fink creó y opera Torvena: marca, storefront headless, Shopify, adquisición y medición sin inventar resultados.",
      },
      en: {
        title: "Torvena",
        ...
        solution: "I defined the category, brand and offer; built a headless storefront organized around needs such as charging, cleaning, autonomy and organization; and connected catalog, cart, checkout, content, campaigns and a first-party measurement layer.",
        role: "I founded and operate Torvena end to end. I directed strategy, product, UX and AI-assisted implementation, as well as catalog, pricing, content, campaigns, support, logistics and day-to-day iteration.",
        decisions: [
          ...
          { title: "Evolve into a headless storefront", text: "After an initial Lovable stage, I rebuilt the experience with Shopify Hydrogen to gain greater control over content, journeys and the visual system." },
        ...
        limits: ["The public store, cart and checkout are operational. What is not available yet is private sign-in for customers to access and manage their accounts.", "First-party paid-order tracking runs in production and is part of day-to-day operations.", "The next step is to add Google Analytics to consolidate traffic, attribution and conversion, and document results against a consistent source and time period."],
        outcomes: ["An active business with real orders and advertising campaigns underway.", "Nationwide operations combining sales, support, logistics and continuous learning.", "Verifiable experience building and operating an owned e-commerce business."],
        seoTitle: "Torvena — Alejandro Fink e-commerce case study",
        seoDescription: "How Alejandro Fink created and operates Torvena: brand, headless storefront, Shopify, acquisition and measurement without invented results.",
      },
    },
  },
  {
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        alt: { es: "Fotografía autorizada del caso real de evolución acompañado por Luca", en: "Authorized photograph from the real progress case supported by Luca" },
        caption: { es: "Caso autorizado 62 kg → 71 kg · período y contexto aún no documentados", en: "Authorized 62 kg → 71 kg case · period and context not yet documented" },
        tone: "dark",
      },
    ],
    content: {
      es: {
        ...
        statusLabel: "Proyecto en desarrollo · Lanzamiento próximo",
        summary: "Construir con un socio una marca de coaching lista para pasar de Instagram a una propuesta digital y comercial propia.",
        ...
        solution: "Desarrollé el posicionamiento, la arquitectura de oferta, el copy, el recorrido a Instagram y una dirección visual editorial a partir de material autorizado.",
        role: "Construyo el proyecto junto a Luca. Aporto concepto comercial, mensaje, UX, dirección visual, frontend asistido por IA y publicación del prototipo; Luca aporta experiencia, servicio, historia, fotografías y validación.",
        decisions: [
          ...
          { title: "Mantener Instagram como cierre inicial", text: "La primera versión utiliza el canal actual de Luca y evita sumar CRM, formulario o agenda antes de definir la operación." },
        ],
        features: ["Landing de una página", "Método, historia y tratamiento de objeciones", "Oferta 1:1 y producto de entrada marcado como próximo", "Filtro de afinidad y FAQs", "CTAs a Instagram"],
        limits: ["La landing aún no se lanzó comercialmente.", "No hay analytics, CRM, agenda, pagos ni entrega del producto digital.", "El caso 62 kg → 71 kg es real y autorizado, pero su período y contexto completo no están documentados."],
        outcomes: ["Sistema comercial y visual acordado entre los socios.", "Prototipo público preparado para evolucionar antes del lanzamiento.", "No existen métricas atribuibles de tráfico, consultas o ventas."],
        seoTitle: "Luca DS — Marca y landing de coaching",
        seoDescription: "Posicionamiento, oferta high-ticket, dirección verbal y landing de Luca DS, con estado previo al lanzamiento claramente visible.",
      },
      en: {
        title: "Luca DS",
        category: "High-ticket · Coaching brand",
        statusLabel: "Project in development · Launch upcoming",
        summary: "Building a coaching brand with a partner, ready to move from Instagram to an owned digital and commercial proposition.",
        ...
        solution: "I developed positioning, offer architecture, copy, the Instagram journey and an editorial art direction from authorized material.",
        role: "I am building the project with Luca. I contribute the commercial concept, messaging, UX, art direction, AI-assisted frontend and prototype publication; Luca contributes expertise, service, story, photography and validation.",
        decisions: [
          ...
          { title: "Keep Instagram as the initial close", text: "The first version uses Luca’s current channel and avoids adding a CRM, form or scheduler before operations are defined." },
        ],
        features: ["Single-page landing", "Method, story and objection handling", "1:1 offer and upcoming entry product", "Fit filter and FAQs", "Instagram calls to action"],
        limits: ["The landing has not launched commercially.", "There is no analytics, CRM, scheduling, payments or digital product delivery.", "The 62 kg → 71 kg case is real and authorized, but its full period and context are not documented."],
        outcomes: ["A commercial and visual system agreed by both partners.", "A public prototype prepared to evolve before launch.", "There are no attributable traffic, inquiry or sales metrics."],
        seoTitle: "Luca DS — Coaching brand and landing page",
        seoDescription: "Positioning, high-ticket offer, verbal direction and landing page for Luca DS, with pre-launch status clearly visible.",
      },
    },
  },
  {
