...
export const projects: Project[] = [
  {
    ...
    content: {
      es: {
        ...
        limits: ["La cuenta de cliente todavía no está habilitada públicamente.", "La integración analítica de pedidos pagados está implementada; su operación en producción debe verificarse antes de usarla como fuente de resultados.", "No se publican métricas cuantitativas hasta acordar período, fuente y alcance."],
      ...
      en: {
        ...
        limits: ["Customer accounts are not publicly enabled yet.", "Paid-order analytics are implemented; their production operation must be verified before using them as a results source.", "No quantitative metrics are published until period, source and scope are agreed."],
